...
export default function ImagePage({ fileToken }: { fileToken: string }) {
  ...
  return (
    <div className="w-dvw h-dvh bg-blue-100 flex justify-center items-center">
      <div className="bg-white rounded-xl relative not-sm:w-[350px] w-[50%] pt-10 overflow-hidden">
        <div className="border-b flex border-gray-200">
          <h3 className="font-semibold p-2 flex text-xl text-gray-900 items-center gap-2 truncate px-5">
